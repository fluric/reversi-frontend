...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReversiApi.Opponent();
  });
  ...
  describe('Opponent', function() {
    it('should create an instance of Opponent', function() {
      // uncomment below and update the code to test Opponent
      //var instance = new ReversiApi.Opponent();
      //expect(instance).to.be.a(ReversiApi.Opponent);
    });
